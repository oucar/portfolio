...
export const experiencesData = [
  {
    ...
    description: [
      "- Applied software design patterns and industry best practices to develop maintainable, high-quality codebase.",
      "- Leveraged Vue.js to create dynamic, responsive user interfaces, complemented with server-side views using Razor Pages.",
      "- Developed and maintained web and Windows applications using C#, .NET, NHibernate, and SQL.",
      "- Provided on-site customer support during end-to-end and system integration testing to ensure smooth go-live processes.",
      ...
      "- Led efforts in building monorepository projects using Rush, implementing custom Vue components via storybooks for enhanced development workflows, and leveraging TypeScript for improved codebase scalability.",
    ],
    icon: "work",
    date: "1/2023 - Present",
  },
  {
    ...
    location: "Navient",
    description: [
      "- Spearheaded Vue.js web app development, emphasizing reusable UI components and mobile-first design. Implemented Vuex for efficient data management.",
      "- Developed and maintained backend services and APIs using C#, .NET 6, and SQL.",
...

  {
    ...
    description: [
      ...
      "- Provided invaluable assistance to students through personalized debugging sessions and elucidated complex computer science topics such as object-oriented programming, data structures, and algorithms, as well as software design principles.",
